...
//
//	@Id
//	@GeneratedValue(strategy= GenerationType.AUTO)//Auto is the default type ..generation type is the strategy you should follow to generate primary key values .The default generation type is auto.when strategy is not specified strategy jpa uses auto startegy.when the underlined database is mysql generation type.auto means jpa will create a hibernate sequence in the database for generation of primary keys. 
